                ...
                <div class="card-body">
                  <form action="{{route('artikel.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('judul') is-invalid @enderror" id="defaultFormControlInput" name="judul" placeholder="Masukan Judul"
                            value="{{old('judul')}}">
                            @error('judul')
                            <div class="invalid-feedback">
                                <i class="bi bi-exclamation-circle-fill"></i>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('referensi') is-invalid @enderror" id="defaultFormControlInput" name="referensi" placeholder="Masukan Referensi"
                            value="{{old('referensi')}}">
                            @error('referensi')
                            <div class="invalid-feedback">
                                <i class="bi bi-exclamation-circle-fill"></i>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="deskripsi" type="text" name="deskripsi" cols="30" rows="5"
                                  class="form-control @error('deskripsi') is-invalid @enderror" style="height: 300px;">{{old('deskripsi')}}</textarea>
                                  @error('deskripsi')
                            <div class="invalid-feedback">
                                <i class="bi bi-exclamation-circle-fill"></i>
                                {{ $message }}
